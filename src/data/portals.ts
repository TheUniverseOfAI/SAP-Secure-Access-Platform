...
export const portals: Portal[] = [
  {
    ...
    cat: 'ai',
    icon: 'RS',
    color: 'linear-gradient(135deg,#1d5cbf,#3b82f6)',
    status: 'live',
  ...
  },
  {
    ...
    cat: 'dev',
    icon: 'CO',
    color: 'linear-gradient(135deg,#1a4080,#1d5cbf)',
    status: 'live',
  ...
  },
  {
    ...
    cat: 'dev',
    icon: 'SV',
    color: 'linear-gradient(135deg,#78350f,#a16207)',
    status: 'live',
  ...
  },
  {
    ...
    cat: 'ai',
    icon: 'AC',
    color: 'linear-gradient(135deg,#86198f,#c026d3)',
    status: 'dev',
  ...
  },
  {
    ...
    cat: 'health',
    icon: 'HL',
    color: 'linear-gradient(135deg,#9f1239,#e11d48)',
    status: 'dev',
