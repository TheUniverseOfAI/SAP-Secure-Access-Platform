 ...
 *
 * "Dashboard" is a new item not in the source: /home now hosts a new
 * mock news/weather landing page, so the original stat-cards/quick-nav/
 * activity dashboard (still built from the real source design) moved to
 * /dashboard and needed its own nav entry.
 */
