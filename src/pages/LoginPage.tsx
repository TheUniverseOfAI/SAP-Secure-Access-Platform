 ...
 * primitives (Button, Input, Checkbox, Tabs) plus one auth-flow-specific
 * component (ConsentBanner). Everything here is clickable but inert -
 * behavior is explicitly deferred to the later wiring phase.
 *
