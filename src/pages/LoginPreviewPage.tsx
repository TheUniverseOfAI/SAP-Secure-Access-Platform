 ...
 * tokens/reset/a11y render correctly against real markup. Scope is
 * deliberately limited to just the header and footer, nothing in between —
 * no consent banner, no auth card, no form.
 *
 * Delete or replace once Phase 6 (real component library) exists — this JSX
 * is not the final Button/AuthLayout structure, just raw markup for a quick
 * style check.
 */
