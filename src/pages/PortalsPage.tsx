...
import { getPortals } from '../api/portalsApi'
 ...
 * #page-portals block. The catalog is fetched via src/api/portalsApi.ts's
 * mocked call rather than imported as a static array. Category filtering
 * works for real (local state), same "structural UI, not business logic"
 * reasoning already applied to routing/tabs/wizard steps elsewhere. Each
 * card's "Launch" link goes nowhere — portal apps are external systems,
 * out of scope for this project entirely, not just deferred to a later
 * phase.
 *
